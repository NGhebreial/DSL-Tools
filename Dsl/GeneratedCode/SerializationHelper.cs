...
namespace ce.GEB_NGN_PCR_Practica1
{
	...
	partial class GEB_NGN_PCR_Practica1DomainModel
	{
		///<Summary>
		...
		partial void InitializeSerialization(DslModeling::Store store)
		{
			...
			GEB_NGN_PCR_Practica1SerializationHelper.Instance.InitializeSerialization(store);	
		}
	}
	
	
	/// <summary>
	/// Helper class for serializing and deserializing GEB_NGN_PCR_Practica1 models.
	/// </summary>
	public abstract partial class GEB_NGN_PCR_Practica1SerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Constructor
		/// </summary>
		protected GEB_NGN_PCR_Practica1SerializationHelperBase() { }
		#endregion
		...
		internal protected virtual void InitializeSerialization(DslModeling::Store store)
		{
			...
			DslModeling::IMonikerResolver monikerResolver = store.FindMonikerResolver(GEB_NGN_PCR_Practica1DomainModel.DomainModelId);
			if (monikerResolver == null)
			{
				monikerResolver = new GEB_NGN_PCR_Practica1SerializationBehaviorMonikerResolver(store, directory);
				store.AddMonikerResolver(GEB_NGN_PCR_Practica1DomainModel.DomainModelId, monikerResolver);
			}
			
			// Add serialization behaviors
			directory.AddBehavior(GEB_NGN_PCR_Practica1SerializationBehavior.Instance);
		}
	...
	/// Helper class for serializing and deserializing GEB_NGN_PCR_Practica1 models.
	/// </summary>
	public sealed partial class GEB_NGN_PCR_Practica1SerializationHelper : GEB_NGN_PCR_Practica1SerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Private constructor to prevent direct instantiation.
		/// </summary>
		private GEB_NGN_PCR_Practica1SerializationHelper() : base () { }
		#endregion
		...
		/// Singleton instance.
		/// </summary>
		private static GEB_NGN_PCR_Practica1SerializationHelper instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static GEB_NGN_PCR_Practica1SerializationHelper Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (GEB_NGN_PCR_Practica1SerializationHelper.instance == null)
					GEB_NGN_PCR_Practica1SerializationHelper.instance = new GEB_NGN_PCR_Practica1SerializationHelper();
				return GEB_NGN_PCR_Practica1SerializationHelper.instance;
			}
		}
		#endregion
	}
...
namespace ce.GEB_NGN_PCR_Practica1
{
	...
	partial class GEB_NGN_PCR_Practica1SerializationHelperBase
	{
	
		/// <summary>
		/// Loads a Prototools instance into the default partition of the given store, and ignore serialization result.
		/// </summary>
		/// <param name="store">The new Prototools instance will be created into the default partition of this store.</param>
		...
		public virtual Prototools LoadModel(DslModeling::Store store, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			#region Check Parameters
			if (store == null) 
				throw new global::System.ArgumentNullException("store");
		...
		/// <summary>
		/// Loads a Prototools instance into the default partition of the given store.
		/// </summary>
		...
		/// </param>
		/// <returns>The loaded Prototools instance.</returns>
		public virtual Prototools LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Store store, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			#region Check Parameters
			if (store == null) 
				throw new global::System.ArgumentNullException("store");
		...
		public virtual Prototools LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Partition partition, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			#region Check Parameters
			...
			{
				throw new global::System.InvalidOperationException(GEB_NGN_PCR_Practica1DomainModel.SingletonResourceManager.GetString("MissingTransaction"));
			}
			
			Prototools modelRoot = null;
			DslModeling::DomainXmlSerializerDirectory directory = this.GetDirectory(partition.Store);
			DslModeling::DomainClassXmlSerializer modelRootSerializer = directory.GetSerializer(Prototools.DomainClassId);
			global::System.Diagnostics.Debug.Assert(modelRootSerializer != null, "Cannot find serializer for Prototools!");
				...
				using (global::System.IO.FileStream fileStream = global::System.IO.File.OpenRead(fileName))
				{
					...
					using (DslModeling::Transaction t = partition.Store.TransactionManager.BeginTransaction("Load Model from " + fileName, true, transactionContext))
					{
						...
						if (fileStream.Length > 5)
						{
							try
							{
								global::System.Xml.XmlReaderSettings settings = GEB_NGN_PCR_Practica1SerializationHelper.Instance.CreateXmlReaderSettings(serializationContext, false);
								using (global::System.Xml.XmlReader reader = global::System.Xml.XmlReader.Create(fileStream, settings))
								{
									...
									modelRoot = modelRootSerializer.TryCreateInstance(serializationContext, reader, partition) as Prototools;
		...
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, Prototools modelRoot, string fileName)
		{
		...
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, Prototools modelRoot, string fileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, Prototools modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		/// <param name="encoding">Encoding to use when saving the Prototools instance.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		/// <returns>In-memory stream containing the serialized Prototools instance.</returns>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		private global::System.IO.MemoryStream InternalSaveModel(DslModeling::SerializationResult serializationResult, Prototools modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			...
			global::System.Xml.XmlWriterSettings settings = GEB_NGN_PCR_Practica1SerializationHelper.Instance.CreateXmlWriterSettings(serializationContext, false, encoding);
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		/// <returns>In-memory stream containing the serialized GEB_NGN_PCR_Practica1Diagram instance.</returns>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		private global::System.IO.MemoryStream InternalSaveDiagram(DslModeling::SerializationResult serializationResult, GEB_NGN_PCR_Practica1Diagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert(serializationResult != null);
			...
			// MonikerResolver shouldn't be required in Save operation, so not calling SetupMonikerResolver() here.
			serializationContext.WriteOptionalPropertiesWithDefaultValue = writeOptionalPropertiesWithDefaultValue;
			global::System.Xml.XmlWriterSettings settings = GEB_NGN_PCR_Practica1SerializationHelper.Instance.CreateXmlWriterSettings(serializationContext, true, encoding);
			using (global::System.Xml.XmlWriter writer = global::System.Xml.XmlWriter.Create(newFileContent, settings))
			{
		...
		/// <summary>
		/// Helper method to create and initialize a new Prototools.
		/// </summary>
		internal protected virtual Prototools CreateModelHelper(DslModeling::Partition modelPartition)
		{
			Prototools model = new Prototools(modelPartition);
			return model;
		}
		
		/// <summary>
		/// Loads a Prototools instance and its associated diagram file into the default partition of the given store, and ignore serialization result.
		/// </summary>
		/// <param name="store">The new Prototools instance will be created into the default partition of this store.</param>
		...
		/// </param>
		/// <returns>The loaded Prototools instance.</returns>
		public virtual Prototools LoadModelAndDiagram(DslModeling::Store store, string modelFileName, string diagramFileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
		...
		/// <summary>
		/// Loads a Prototools instance and its associated diagram file into the default partition of the given store.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the load operation.</param>
		/// <param name="store">The new Prototools instance will be created into the default partition of this store.</param>
		/// <param name="modelFileName">Name of the file from which the Prototools instance will be deserialized.</param>
		...
		public virtual Prototools LoadModelAndDiagram(DslModeling::SerializationResult serializationResult, DslModeling::Partition modelPartition, string modelFileName, DslModeling::Partition diagramPartition, string diagramFileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			...
			GEB_NGN_PCR_Practica1Diagram diagram = null;
			DslModeling::DomainXmlSerializerDirectory directory = this.GetDirectory(diagramPartition.Store);
			DslModeling::DomainClassXmlSerializer diagramSerializer = directory.GetSerializer(GEB_NGN_PCR_Practica1Diagram.DomainClassId);
			global::System.Diagnostics.Debug.Assert(diagramSerializer != null, "Cannot find serializer for GEB_NGN_PCR_Practica1Diagram");
						...
						using (DslModeling::Transaction t = diagramPartition.Store.TransactionManager.BeginTransaction("LoadDiagram", true, transactionContext))
						{
							...
							if (fileStream.Length > 5)
							{
								...
								try
								{
									...
									{
										reader.MoveToContent();
										diagram = diagramSerializer.TryCreateInstance(serializationContext, reader, diagramPartition) as GEB_NGN_PCR_Practica1Diagram;
										if (diagram != null)
										{
		...
		/// <summary>
		/// Helper method to create and initialize a new GEB_NGN_PCR_Practica1Diagram.
		/// </summary>
		...
		internal protected virtual GEB_NGN_PCR_Practica1Diagram CreateDiagramHelper(DslModeling::Partition diagramPartition, DslModeling::ModelElement modelRoot)
		{
			GEB_NGN_PCR_Practica1Diagram diagram = new GEB_NGN_PCR_Practica1Diagram(diagramPartition);
			return diagram;
		}
		...
		/// <param name="diagram">GEB_NGN_PCR_Practica1Diagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, Prototools modelRoot, string modelFileName, GEB_NGN_PCR_Practica1Diagram diagram, string diagramFileName)
		{
		...
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, Prototools modelRoot, string modelFileName, GEB_NGN_PCR_Practica1Diagram diagram, string diagramFileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, Prototools modelRoot, string modelFileName, GEB_NGN_PCR_Practica1Diagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		/// <param name="diagram">GEB_NGN_PCR_Practica1Diagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, GEB_NGN_PCR_Practica1Diagram diagram, string diagramFileName)
		{
		...
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, GEB_NGN_PCR_Practica1Diagram diagram, string diagramFileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <summary>
		/// Saves the given GEB_NGN_PCR_Practica1Diagram to the given file, with specified encoding.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the save operation.</param>
		/// <param name="diagram">GEB_NGN_PCR_Practica1Diagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, GEB_NGN_PCR_Practica1Diagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		public virtual void WriteRootElement(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement rootElement, global::System.Xml.XmlWriter writer)
		{
			...
			if (!(rootElement is DslDiagrams::Diagram))
			{
				...
				rootElementSettings.SchemaTargetNamespace = "http://schemas.microsoft.com/dsltools/GEB_NGN_PCR_Practica1";
			}
		...
		protected virtual void CheckVersion(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader)
		{
			...
			if (dslVersionStr != null)
			{
				try
				{
					...
					{
						GEB_NGN_PCR_Practica1SerializationBehaviorSerializationMessages.VersionMismatch(serializationContext, reader, expectedVersion, actualVersion);
					}
				}
				catch (global::System.ArgumentException)
				{
					GEB_NGN_PCR_Practica1SerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, "dslVersion", typeof(global::System.Version), dslVersionStr);
				}
		...
		protected virtual global::System.Xml.XmlReader TryCreateValidatingReader(DslModeling::ISchemaResolver schemaResolver, global::System.Xml.XmlReader reader, DslModeling::SerializationContext serializationContext)
		{
			...
			if (success && schemaSet.Count > 0)
			{
				...
				GEB_NGN_PCR_Practica1SerializationBehaviorSchemaValidationCallback validationCallback = new GEB_NGN_PCR_Practica1SerializationBehaviorSchemaValidationCallback(serializationContext);
		...
		protected static bool ResolveSchema(string targetNamespace, global::System.Xml.Schema.XmlSchemaSet schemaSet, DslModeling::ISchemaResolver schemaResolver, global::System.Xml.XmlReader reader, DslModeling::SerializationContext serializationContext)
		{
			...
			if (schemas != null && schemas.Count > 0)
			{
				if (schemas.Count > 1)
				{
					GEB_NGN_PCR_Practica1SerializationBehaviorSerializationMessages.AmbiguousSchema(serializationContext, reader, targetNamespace, schemas[0]);
				}
				schemaSet.Add(targetNamespace, schemas[0]);
				return true;
			}
	
			GEB_NGN_PCR_Practica1SerializationBehaviorSerializationMessages.NoSchema(serializationContext, reader, targetNamespace);
			return false;
		}
		...
		/// </summary>
		private sealed class GEB_NGN_PCR_Practica1SerializationBehaviorSchemaValidationCallback
		{
			...
			internal GEB_NGN_PCR_Practica1SerializationBehaviorSchemaValidationCallback(DslModeling::SerializationContext serializationContext)
			{
				global::System.Diagnostics.Debug.Assert(serializationContext != null);
			...
			internal void Handler(object sender, global::System.Xml.Schema.ValidationEventArgs e)
			{
				...
				if (this.serializationContext != null)
					GEB_NGN_PCR_Practica1SerializationBehaviorSerializationMessages.SchemaValidationError(this.serializationContext, this.reader, e.Message);
			}
			#endregion
		}
		...
		public virtual string GetSerializedModelString(global::ce.GEB_NGN_PCR_Practica1.Prototools modelRoot, global::System.Text.Encoding encoding)
		{
...
namespace ce.GEB_NGN_PCR_Practica1
{
	...
	public partial class Prototools
	{
		/// <summary>
		...
		private void ValidateMonikerAmbiguity(DslValidation::ValidationContext context)
		{
			...
			global::System.Collections.Generic.IDictionary<global::System.Guid, DslModeling::IMonikerResolver> monikerResolvers = GEB_NGN_PCR_Practica1SerializationHelper.Instance.GetMonikerResolvers(this.Store);
						...
						{	// Ambiguous moniker detected.
							context.LogError(
								string.Format(
									...
									GEB_NGN_PCR_Practica1DomainModel.SingletonResourceManager.GetString("AmbiguousMoniker"),
									amEx.Moniker,
