...
namespace ce.GEB_NGN_PCR_Practica1
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides GEB_NGN_PCR_Practica1 files
	/// The implementation is done in GEB_NGN_PCR_Practica1DirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class GEB_NGN_PCR_Practica1DirectiveProcessor : GEB_NGN_PCR_Practica1DirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public GEB_NGN_PCR_Practica1DirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides GEB_NGN_PCR_Practica1 files
	/// </summary>
	public class GEB_NGN_PCR_Practica1DirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string GEB_NGN_PCR_Practica1DirectiveProcessorName = "GEB_NGN_PCR_Practica1DirectiveProcessor";
		...
		/// </summary>
		private const string providesModelParameter = "Prototools";
		...
		/// </summary>
		private const string supportedDirectiveName = "GEB_NGN_PCR_Practica1";
		...
		/// Constructor
		/// </summary>
		public GEB_NGN_PCR_Practica1DirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return GEB_NGN_PCR_Practica1DirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::ce.GEB_NGN_PCR_Practica1.Prototools));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::ce.GEB_NGN_PCR_Practica1.Prototools));
					...
					if (!this.oneTimeCodeGenerated && global::System.IO.File.Exists(this.Host.TemplateFile))
					{
						...
						resolver.Name = "Convert" + "Prototools" + "RelativePathToTemplateRelativePath";
		...
		public override string[] GetImportsForProcessingRun()
		{
			...
			imports.Add("ce.GEB_NGN_PCR_Practica1");
