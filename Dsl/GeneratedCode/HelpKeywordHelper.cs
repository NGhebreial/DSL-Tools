...
namespace ce.GEB_NGN_PCR_Practica1
{
	...
	/// </remarks>
	public partial class GEB_NGN_PCR_Practica1HelpKeywordHelper : GEB_NGN_PCR_Practica1HelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new GEB_NGN_PCR_Practica1HelpKeywordHelper.
		/// </summary>
		protected GEB_NGN_PCR_Practica1HelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the GEB_NGN_PCR_Practica1HelpKeywordHelper.
		/// </summary>
		public static GEB_NGN_PCR_Practica1HelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class GEB_NGN_PCR_Practica1HelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new GEB_NGN_PCR_Practica1HelpKeywordHelperBase.
		/// </summary>
		protected GEB_NGN_PCR_Practica1HelpKeywordHelperBase()
			: base() { }
